...
void sub_14215D05C(Vector3 a1, __int64 a2)
{
	__int64 v2; // rbx
	int v3; // esi
	_BYTE* v5; // rcx
	...
	int v31; // eax
	uintptr_t v32;
	v32 = read<uintptr_t>(addresses::localplayer + 0xd0); // view0
	v33 = read<uintptr_t>(v32 + 0x10); //view1
	v34 = read<uintptr_t>(addresses::uworld + 0x100); //ptrloc
	v29 = 346;
	v2 = a2 + 12905;
	v3 = 3;
	if (a2)
	{
		...
		v543 = asin(read<double>(v33 + 0x680)) * (180.0 / M_PI);
		v324 = read<double>(v33 + 0x7D0);
		v893 = read<double>(v33 + 0x148);
		CachedCamera::FieldOfView = 80.0f / (read<double>(v33 + 0x680) / 1.19f);
		CachedCamera::location = read<Vector3>(v34);
		v812 = atan2(v893, v324) * (180.0 / M_PI);
		v812 *= -1;

		zoom = v33;

		CachedCamera::Pitch = v543;
		CachedCamera::Yaw = v812;
		CachedCamera::ptr = v34;
